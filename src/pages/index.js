   ...
   const handleSubmit = (e) =>{
    ...
    return (
        <div className="w-full h-screen mainc bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0">
          <form className={`${animate ? 'animate-shake' : 'animate-none'} h-16 bg-black/30 w-full max-w-md rounded-full backdrop-blur-[32px] mb-8`}>
              <div className="form-control h-full relative flex items-center justify-between p-2">
                  <div className="input-group flex-1">
                      <input type="text"
                             onChange={(e)=>handleInput(e)}
                             border-0
                             placeholder="Enter your city…" className="input
                             focus:outline-0
                        ...
                        <div className="max-w-[378px] mx-auto flex flex-col gap-y-6">
                            ...
                            <div className="flex justify-between">
                                <div className="flex items-center gap-x-2">
                                    ...
                                    <div>
                                        Humidity <span className="ml-2">{data.humidity} %</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-x-2">
                                    <div className="text-[20px]">
